...
Day 1 originally proved the engine with generated audio. The current implementation now plays included MP3 pad files:
...
This proves the file-backed pad path using the single included v1 pad library.
